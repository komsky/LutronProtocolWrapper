    ...
    public class PulseTests
    {
        ...
        public class Constructor
        {
            ...
            public class WhenHoursAreLessThanZero
            {
                ...
                {
                    Assert.Throws<ArgumentException>(() => new Pulse(-1, 0, 0, 0));
                }
            }
            ...
            public class WhenMinutesAreLessThanZero
            {
                ...
                public void ShouldThrowException()
                {
                    Assert.Throws<ArgumentException>(() => new Pulse(0, -1, 0, 0));
                }
            }
            ...
            public class WhenMinutesAreGreaterThan59
            {
                ...
                public void ShouldThrowException()
                {
                    Assert.Throws<ArgumentException>(() => new Pulse(0, 60, 0, 0));
                }
            }
            ...
            public class WhenSecondsAreLessThanZero
            {
                ...
                public void ShouldThrowException()
                {
                    Assert.Throws<ArgumentException>(() => new Pulse(0, 0, -1, 0));
                }
            }
            ...
            public class WhenSecondsAreGreaterThan59
            {
                ...
                public void ShouldThrowException()
                {
                    Assert.Throws<ArgumentException>(() => new Pulse(0, 0, 60, 0));
                }
            }
            ...
            public class WhenFractionalIsLessThanZero
            {
                ...
                public void ShouldThrowException()
                {
                    Assert.Throws<ArgumentException>(() => new Pulse(0, 0, 0, -1));
                }
            }
            ...
            public class WhenFractionalIsGreaterThan99
            {
                ...
                public void ShouldThrowException()
                {
                    Assert.Throws<ArgumentException>(() => new Pulse(0, 0, 0, 100));
                }
            }
        }
        ...
        public class WhenToString
        {
            ...
            public class WhenThereAreSecondsWithFractional
            {
                ...
                {
                    var pulse = new Pulse(0, 0, 4, 25);

                    Assert.AreEqual("4.25", pulse.ToString());
                }
            }
            ...
            public class WhenThereAreSecondsOnly
            {
                ...
                {
                    var pulse = new Pulse(0, 0, 4, 0);

                    Assert.AreEqual("4", pulse.ToString());
                }
            }
            ...
            public class WhenThereMinutesAndSecondsOnly
            {
                ...
                {
                    var pulse = new Pulse(0, 16, 4, 0);

                    Assert.AreEqual("16:04", pulse.ToString());
                }
            }
            ...
            public class WhenThereHoursMinutesAndSecondsOnly
            {
                ...
                {
                    var pulse = new Pulse(3, 16, 4, 0);

                    Assert.AreEqual("03:16:04", pulse.ToString());
                }
            }
            ...
            public class WhenThereAreNoHoursMinutesSecondsOrFractional
            {
                ...
                public void ShouldReturnZeroString()
                {
                    ...
                    Assert.AreEqual("1", pulse.ToString());
                }
            }
            ...
            public class WhenThereAreMinutesOnly
            {
                ...
                {
                    var pulse = new Pulse(minutes: 15);

                    Assert.AreEqual("15:00", pulse.ToString());
                }
            }
            ...
            public class WhenThereAreHoursAndMinutesOnly
            {
                ...
                {
                    var pulse = new Pulse(hours: 2, minutes: 15);

                    Assert.AreEqual("02:15:00", pulse.ToString());
                }
            }
            ...
            public class WhenThereAreHoursOnly
            {
                ...
                {
                    var pulse = new Pulse(hours: 2);

                    Assert.AreEqual("02:00:00", pulse.ToString());
                }
            }
        }
    }
